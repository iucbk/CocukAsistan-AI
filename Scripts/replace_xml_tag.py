...
parser.add_argument('--tag', type=str, required=True, help='Tag that its value will be changed')
parser.add_argument('--value', type=str, required=True, help='New value of the tag')
